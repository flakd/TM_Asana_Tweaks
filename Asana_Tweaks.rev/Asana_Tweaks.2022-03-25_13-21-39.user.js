...
(function() {
	// BEGIN ===========================================
		...
		********************************/
		...
		let completedTaskBgColor = null //"#334433";
		let completedTaskTextColor = null //"#777777";
	...
	//---------------------------------------------- END
		...
		function checkForShortcutKey(evt) {
			//function detectKeyPress_CTRL_KEY(evt,keycode) {
		...
		function openHelpOnKeyPress(){
			...
			w.document.body.innerHTML = getHighlightHelpHTML();
		}
		function getHighlightHelpHTML(){
			const helpCellTextArray = getBullets();
		...
		function prepUIForChanges(){
			document.onkeyup = checkForShortcutKey;

			setUpHelpCheatSheet();
			hideUpgradeBtn();
			const appendToElement = setAppendToElement();
			//createToolBarBtn(appendToElement, btnID, btnClass, btnText, btnClickHandler);
			//createToolBarBtn(appendToElement, "btnTBarVisHighlight", "btnTBarVisHighlight", "Toggle TBars", setAllToolBarsVis("highlight") );
			//createToolBarBtn(appendToElement, "btnTBarVisToggle", "btnTBarVisToggle", "Toggle TBars", setAllToolBarsVis("toggle") );
			//createToolBarBtn(appendToElement, "btnTBarVisHide", "btnTBarVisHide", "Hide TBars", setAllToolBarsVis("hide") );
			createToolBarBtn_Highlight(appendToElement);
			createToolBarBtn_ToggleBars(appendToElement);
			createToolBarBtn_HideBars(appendToElement);
			setStyleSheet();
		}

		function setUpHelpCheatSheet(){
//			document.onkeydown = detectKeyPress_CTRL_KEY(191); // FORWARD SLASH key
			document.onkeydown = checkForShortcutKey;
    ...
    function createToolBarBtn_Highlight(addToElement){
		...
		function createToolBarBtn_ToggleBars(addToElement){
			let btn = document.createElement("button");
		...
		function createToolBarBtn_HideBars(addToElement){
			let btn = document.createElement("button");
    ...
    function nullError(caller, errMsg){
		...
		// BEGIN: "Not Implemented Functions" ================
		/*******************************************************************
